...
#'
#' Estimates the transformation parameter for the Box-Cox transformation employing the profile log-likehood. Only accepts positive values for the dependent variable.
...
# #' @param lambdarange range for the estimation parameter lambda - c(-2,2)
