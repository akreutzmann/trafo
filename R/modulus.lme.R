#' Modulus transformation for linear mixed models
#'
#' The function transforms the dependent variable of a linear mixed model with 
#' one random intercept using the Modulus transformation. The 
...
#' modulus(object = lme_Vienna, lambda = "estim", method = "reml",
#' plotit = FALSE)
#' @export

modulus.lme <- function(object, lambda = "estim", method = "reml", 
