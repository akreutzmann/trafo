...
#'
#' Transforms the dependent variable of a regression model using the Manly
...
#' @seealso  \code{\link{manly.lm}},  \code{\link{manly.lme}}
#' @keywords Manly
#' @export
manly <- function(object, ...) UseMethod("manly")
