...
#' @references 
#' Kelmansky DM, Martinez EJ, Leiva V (2013). A New Variance Stabilizing 
#' Transformation for Gene Expression Data Analysis. Statistical applications in 
#' genetics and molecular biology, 12(6), 653-666.
#' @examples
#' # Load data
